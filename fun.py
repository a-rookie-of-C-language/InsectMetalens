...
def Fun_FitnessLenserror(TargetFWHM, TargetSidlobe, TargetPeakIntensity, TargetFocal_offset, FWHM, SideLobe, IntensPeak,
    ...
    :return:
    """
    d = [10, 2, 10, 0.01, 0.01, 10]
    fitness1 = abs(TargetPeakIntensity - IntensPeak) / TargetPeakIntensity*50  # 强度偏差500
    fitness2 = abs(Focal_offset - TargetFocal_offset) *1000  # 焦斑偏移量0.001
    ...
    fitness6 = 10**4/np.min(Intensity_sum) #max min()
